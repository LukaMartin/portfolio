    ...
    <>
      <div className="h-[9rem] bg-[#121212] text-white border-b-[1px] border-b-[#252525]">
        <nav className="hidden md:flex justify-between max-w-[75rem] lg:mx-2 xl:mx-auto h-full items-center">
          <h1 className="md:text-2xl lg:text-3xl pl-8 xl:pl-1">
            Luka Martin Portfolio
          </h1>
          <ul className="flex text-xl text-white/80">
            <a href="#about-me">
        ...
        <div className="h-[9rem] text-white md:hidden flex justify-between items-center px-8">
          <h1 className="max-w-[66%] xs:max-w-full text-2xl">
            Luka Martin Portfolio
          </h1>
          {!toggleView && (
            <FiMenu size={30} onClick={() => setToggleView(!toggleView)} />
          )}
        </div>
        <div
          className={
            toggleView
              ? "fixed top-0 left-0 bg-[#020202] text-white h-full w-screen ease-in-out duration-700 md:hidden"
        ...
        >
          ...
          <ul className="text-lg pl-8">
            <a onClick={() => setToggleView(false)} href="#about-me">
              <li className="mr-20 pb-5 hover:underline border-b-2 border-b-white">
                About Me
              </li>
            </a>
            <a onClick={() => setToggleView(false)} href="#projects">
              <li className="mr-20 py-5 hover:underline border-b-2 border-b-white">
                Projects
              </li>
            </a>
            <a onClick={() => setToggleView(false)} href="#contact">
              <li className="mr-20 pt-5 hover:underline">Contact</li>
            </a>
          </ul>
