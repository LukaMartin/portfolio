...
export default function Skills() {
    ...
    return (
        <div data-aos="zoom-in" id="skills" className="bg-[#070808] rounded-xl text-white p-6 md:p-8 mx-4 xl:mx-0 md:mx-[7.5rem] lg:mx-8 lg:w-[42%] lg:my-40 lg:max-h-[24rem]">
            ...
            <div className="md:hidden flex justify-between pt-8 lg:pt-20">
                <FaHtml5 size={38} className="text-[#F06529]" />
                <FaCss3Alt size={38} className="text-[#2965f1]" />
                <RiJavascriptFill size={38} className="text-[#f7df1e]" />
                <FaReact size={38} className="text-[#61DBFB]" />
            </div>
        </div>
    )
};