...
export default function Skills() {
    ...
    return (
        <div data-aos="zoom-in" className="bg-[#121212] border-[1px] border-[#252525] rounded-xl text-white p-6 md:p-8 mx-4 xl:mx-0 md:mx-[7.5rem] lg:mx-8 lg:w-[42%] lg:my-40 lg:max-h-[23.55rem]">
            ...
            <p className="mb-2">My skills currently include <span className="font-[600]">HTML</span>, <span className="font-[600]">CSS</span>, <span className="font-[600]">JavaScript</span>, <span className="font-[600]">TypeScript</span>, <span className="font-[600]">React</span> and <span className="font-[600]">NextJs</span> .</p>
